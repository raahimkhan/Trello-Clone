...
const Board = () => {
    ...
    const addList = async () => {
        ...
        await dispatch(createNewListReducer({listTitle: modalText}));
        setModalText('');
        closeModal();
    }
    ...
    return (
        <div className="board-container">
            <DragDropContext onDragStart={() => console.log('Drag Started')} onDragEnd={async (results) => await dispatch(dragReducer({results: results}))}>
