...
const List = ({ list }) => {
    ...
    const addTask = async () => {
        ...
        await dispatch(createNewTaskReducer({listId: list.listId, taskTitle: taskValue}));
        setTaskValue('');
    }
    ...
    const editListTitle = async () => {
        ...
        await dispatch(editListTitleReducer({listId: list.listId, updatedListTitle: modalText}));
        setModalText('');
        closeModal();
    }

    const deleteList = async () => {
        await dispatch(deleteListReducer({listId: list.listId}));
    }
